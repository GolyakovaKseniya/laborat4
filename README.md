...
### Алгоритм решения
Создадим необходимый метод, принимающий коробку, параметризованную типом, являющимся точкой или другим типом, являющимся для нее родительским. Используем маску <? super> (нижняя граница), так как нам нужно именно записать точку в коробку. В методе проверяем пуста ли коробка, если да, то создаем точку и добавляем ее. В методе main создаем объект класса и коробки с разными типами и добавляем ее в список. Потом вводим все координаты и помещаем созданную точку в коробку. Можно вывести состояние всех коробок, а также извлечь все элементы.
#### Пример вывода
